...
#define BLUETOOTH_CH9141_UART           USART_8         //无线转串口模块 所使用到的串口     
#define BLUETOOTH_CH9141_UART_TX        UART8_TX_D16    //蓝牙的RX连接单片机的D16引脚
#define BLUETOOTH_CH9141_UART_RX        UART8_RX_D17    //蓝牙的TX连接单片机的D17引脚
#define BLUETOOTH_CH9141_UART_BAUD      115200

#define BLUETOOTH_CH9141_RTS_PIN        D26             //定义流控位引脚  指示当前模块是否可以接受数据  0可以继续接收  1不可以继续接收
