...
Pic-o Link 成品[兼容逐飞无线串口接口(去除SDIO)，集成固件]及致用上位机（可配置 Pic-o Link 参数）已上架淘宝：https://m.tb.cn/h.fLp50d0?tk=2Hlu26q4nDN
...
- 电脑使用 USB 转 TTL 串口助手连接 Pic-o Link，短接 MOSI 和 CS 引脚再复位，指示灯显示黄色代表进入配置模式，此时可以通过串口配置 Pic-o Link 参数，**波特率115200**，协议见表格
